...
% y_assimptote = 0:0.01:1500;
% x_assimptote = ones(1,150001)*0.0595;
...
for i = 1:2
    ...
    plot(ax,numCars(1,:)/500,numCrosses(i,:)/2,colArray{i},'LineWidth',2,'DisplayName',dispname)
end
% lgd.FontSize = 10;
...
plot(ax,numCars(1,:)/500,numCrosses(3,:)/2,'g-','LineWidth',2,'DisplayName',dispname)
% lgd.FontSize = 10;

title(ax,' ','FontSize',16)

y_assimptote = 0:0.01:1500;
x_assimptote = ones(1,150001)*0.062;
...
for i = 4:5
    dispname = sprintf('a_{IDM} = %s m/s^2',num2str(a_val(i)));
    plot(ax,numCars(1,:)/500,numCrosses(i,:)/2,colArray{i-3},'LineWidth',2,'DisplayName',dispname)
end
% lgd.FontSize = 10;
