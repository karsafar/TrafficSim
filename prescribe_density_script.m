...
init_density.vertical = 0.04-logspace(log10(0.001),log10(0.035),InitNumberOfSimRuns);
...
for k = 1:numberOfSimRuns
    ...
    subRoadArgs.Vertical = [{allCarsNumArray(k).vertical},numCars.vertical(k),nIterations];
    
    sim(k) = run_simulation({roadTypes{1},roadTypes{1}},carTypes,subRoadArgs,t_rng,plotFlag,priority,road,nIterations,dt);
end
toc
save('/Users/robot/car_sim_mat_Files/density_07_05_0_0.mat','prescription','carTypeRatios','carTypes','numCars','allCarsNumArray',...
