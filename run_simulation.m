...
HorizontalArm = roadTypes{1}([{carTypes},0,roadDims,priority],subRoadArgs.Horizontal,dt);
VerticalArm = roadTypes{2}([{carTypes},90,roadDims,priority],subRoadArgs.Vertical,dt);
